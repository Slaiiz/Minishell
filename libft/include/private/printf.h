...
/*   Updated: 2016/10/10 15:50:01 by vchesnea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			get_flags(t_format *out, char const **s);
void			get_precision(t_format *out, char const **s);
void			get_modifier(t_format *out, char const **s);
void			get_conversion(t_format *out, char const **s);
size_t			sign_extend(t_format *format, size_t arg);
void			pad_buffer(t_buffer *buf, t_format *in, int fpad, int ppad);
void			parse_extras(t_buffer *buf, char const **format);
void			write_to_buffer(t_buffer *in, int mode, int len, char const *s);
